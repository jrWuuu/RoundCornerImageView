...
// 获取自定义数据
    private void inital(Context context, AttributeSet attrs) {
        ...
        borderRadius = dp2px(array.getDimension(R.styleable.RCImageView_borderRadius, BODER_RADIUS_DEFAULT));
        type = array.getInt(R.styleable.RCImageView_type, TYPE_NORMAL);
        border_width = dp2px(array.getDimension(R.styleable.RCImageView_borderWidth, BORDER_WIDTH));
        border_color = array.getInt(R.styleable.RCImageView_borderColor, BORDER_COLOR);
        array.recycle();
    }
